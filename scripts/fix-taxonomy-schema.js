...
/**
 * Script to fix taxonomy schema and remove legacy category data
 */
...
async function fixTaxonomySchema() {
  console.log('🚀 Fixing taxonomy schema and removing legacy data...\n');
  ...
  try {
    ...
    // Step 3: Drop and recreate taxonomy table
    console.log('📋 Step 3: Recreating taxonomy table...');
    ...
    // Test adding a product type to verify schema works
    console.log('\n🧪 Step 6: Testing schema...');
    try {
    ...
    console.log('\n🎉 Taxonomy schema fix completed successfully!');
